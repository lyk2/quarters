...
\node [block2, below of=chore](chat){12. Deletes Chore};
\node [block2, below of=chat](message){13. Adds Post};
\node [block2, below of=message](post){14. Adds Comment};
\node [block2, below of=post](comment){15. Deletes Post};
...
\textbf{Requirement \#:} 12
      ...
      \tab{\textbf{Priority:} 3} \\
      \textbf{Description: }{Financial platform that provides users with the option to make payments via PayPal.} \\
      \textbf{Rationale: }{Payments between users may be processed within the 
platform to discard the need to handle cash or to use post-dated cheques.} \\
