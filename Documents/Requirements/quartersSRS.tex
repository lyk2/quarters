...
\node [block, right of=join, xshift=5cm](database){Database};
\node [block, right of=message, xshift=5cm](server){Web Server};

% Place lines
\draw [arrow] (user) -- (account);
\draw [arrow] (user) -- (delete);
\draw [arrow] (user) -- (login);
\draw [arrow] (user) -- (logout);
\draw [arrow] (user) -- (create);
\draw [arrow] (user) -- (join);
\draw [arrow] (user) -- (leave);
\draw [arrow] (user) -- (upload);
\draw [arrow] (user) -- (submit);
\draw [arrow] (user) -- (update);
\draw [arrow] (user) -- (chore);
\draw [arrow] (user) -- (chat);
\draw [arrow] (user) -- (message);
\draw [arrow] (user) -- (post);
\draw [arrow] (user) -- (comment);
\draw [arrow] (user) -- (funds);

\draw [arrow] (database) -- (account);
\draw [arrow] (database) -- (delete);
\draw [arrow] (database) -- (login);
\draw [arrow] (database) -- (logout);
\draw [arrow] (database) -- (create);
\draw [arrow] (database) -- (join);
\draw [arrow] (database) -- (leave);
\draw [arrow] (database) -- (upload);
\draw [arrow] (database) -- (submit);
\draw [arrow] (database) -- (update);
\draw [arrow] (database) -- (chore);
\draw [arrow] (database) -- (chat);
\draw [arrow] (database) -- (message);
\draw [arrow] (database) -- (post);
\draw [arrow] (database) -- (comment);
\draw [arrow] (database) -- (funds);

\draw [arrow] (server) -- (account);
\draw [arrow] (server) -- (delete);
\draw [arrow] (server) -- (login);
\draw [arrow] (server) -- (logout);
\draw [arrow] (server) -- (create);
\draw [arrow] (server) -- (join);
\draw [arrow] (server) -- (leave);
\draw [arrow] (server) -- (upload);
\draw [arrow] (server) -- (submit);
\draw [arrow] (server) -- (update);
\draw [arrow] (server) -- (chore);
\draw [arrow] (server) -- (chat);
\draw [arrow] (server) -- (message);
\draw [arrow] (server) -- (post);
\draw [arrow] (server) -- (comment);
\draw [arrow] (server) -- (funds);
