...
There are an abundant of other stakeholders than can provide valuable insight towards the product. \\
These people/organizations include:\\
\begin{itemize}
\item Business analyst can collect the potential data, and complete data analyse on it.
\item Plumbers, and electricians can also provide information directly to solving maintenance issues in the house.
...
There are two key users that will be using this platform where these users are critical to the product, thus the requirements generated is heavily influenced by tenants and landlords.\\
